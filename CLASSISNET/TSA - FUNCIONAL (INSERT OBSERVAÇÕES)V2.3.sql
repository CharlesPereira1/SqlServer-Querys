...
CASE 
	...
	WHEN (100.0 * DATEDIFF(MINUTE, SET4.ENTRADA, SET4.SAIDA ) / DATEDIFF(MINUTE, SET4.HORARIO_INICIAL_AULA, SET4.HORARIO_FINAL_AULA) <= 70) 
		...
		THEN '2 - O ALUNO NÃO ASSISTIU  70% DE AULA PREVISTA NA DISCIPLINA DE '+UPPER(SET4.NOME_DISCIPLICA)
	WHEN DATEADD(MINUTE,-3, SET4.ENTRADA_ACESSO) > SET4.HORARIO_INICIAL_AULA AND SET4.ENTRADA_ACESSO < SET4.HORARIO_FINAL_AULA AND SET4.AULA=01
		THEN '3 - O ALUNO CHEGOU ATRASADO NA DISCIPLINA DE '+UPPER(SET4.NOME_DISCIPLICA) 
	...
	WHEN SET4.ENTRADA_ACESSO > SET4.HORARIO_INICIAL_AULA AND SET4.ENTRADA_ACESSO > SET4.HORARIO_FINAL_AULA OR SET4.SAIDA_ACESSO < SET4.HORARIO_INICIAL_AULA
		THEN '4 - O ALUNO NÃO ASSISTIU A AULA DE '+UPPER(SET4.NOME_DISCIPLICA)
	...
	WHEN (100.0 * DATEDIFF(MINUTE, SET4.ENTRADA, DATEADD(MINUTE,3, SET4.SAIDA) ) / DATEDIFF(MINUTE, SET4.HORARIO_INICIAL_AULA, SET4.HORARIO_FINAL_AULA) >= 70) 
		...
		THEN 'O ALUNO CHEGOU APÓS O INICIO DAS AULAS MAS TEVE 70% DE APROVEITAMENTO NA DISCIPLINA'
ELSE
...
--SELECT * FROM SOCORRENCIAALUNO WHERE CODCOLIGADA=1