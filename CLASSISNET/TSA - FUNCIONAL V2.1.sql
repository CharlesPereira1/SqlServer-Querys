...
( 
  CASE 
       WHEN SET3.HORARIO_INICIAL_ALULA <= SET3.ENTRADA_ACESSO AND SET3.DATA_AULODISCIPLICA = SET3.DATA_ACESSOCATRACA THEN 'A'
	   WHEN SET3.HORARIO_FINAL_AULA  <= SET3.SAINDA_ACESSO AND SET3.ENTRADA_ACESSO IS NOT NULL THEN 'F'
	   ELSE 'A'
	   END) PRECENSA_FALTA,
NULL AS JUSTIFICADA,
...
WHERE-- CONVERT (DATETIME, EVA.DATA) = GETDATE() --'2018-04-06'
